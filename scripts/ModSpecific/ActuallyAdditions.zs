...
//  Iron casing
//  Hint: in gtlite, we renamed this block to 'Electrical Steel Casing'.
...
//  TODO Maybe add this to gregtech material system.
furnace.remove(<actuallyadditions:item_misc:5>);

//  Quartzite -> Black Quartz dust 
...
//  Black Quartz dust -> Black Quartz gem
...
assembler.recipeBuilder()
    ...
    .fluidInputs([<liquid:ruridit> * (L * 4)])
