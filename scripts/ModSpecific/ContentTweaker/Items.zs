...
var machine_core_computer = VanillaFactory.createItem("machine_core_computer");
    machine_core_computer.maxStackSize = 64;
    machine_core_computer.creativeTab = <creativetab:appliedenergistics2>;
    machine_core_computer.register(); 

var machine_core_mainframe = VanillaFactory.createItem("machine_core_mainframe");
    machine_core_mainframe.maxStackSize = 64;
    machine_core_mainframe.creativeTab = <creativetab:appliedenergistics2>;
    machine_core_mainframe.register(); 
